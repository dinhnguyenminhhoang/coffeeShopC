...
const RecentOrders = () => {
    ...
    const orderRecentData = useSelector((state) => state.orderRecentData.data);
    useEffect(() => {
                    ...
                    <table className="w-full whitespace-nowrap">
                        ...
                        <tbody className="divide-y  divide-gray-700 bg-gray-800 text-gray-400">
                            {orderRecentData?.data &&
                                orderRecentData.data?.map((orderRecent) => (
                                    <tr
